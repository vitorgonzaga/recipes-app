    ...
    <main>
      {drinks
        && drinks.map((item, index) => {
          const { strDrink, strDrinkThumb, strAlcoholic, strInstructions } = item;
          return (
            <div key={ index }>
              <div className="container-details">
                ...
                <div className="container-title">
                  {/* <div> */}
                  <h1 data-testid="recipe-title" className="details-name">
                    {strDrink}
                  </h1>
                  {/* </div> */}
                  <button
                  ...
                  <FavoriteDrink drinks={ drinks } typeCategory="bebida" />
                </div>
                <h3 data-testid="recipe-category" className="details-optional">
                  {strAlcoholic}
                </h3>
                <section>
